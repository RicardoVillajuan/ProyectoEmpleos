...
import net.unjfsc.util.Utileria;
...
public class VacantesController {
	...
	// Cuando usamos DataBinding es decir que en ves de recibir , todos los
	// parametros
	// con @RequestParam pues lo recibimos en el mismo objeto Ejemplo. Vacante
	// vacante
	// Haciendo esto podria generar algunos errores como errores de formato y
	// errores de conversin
	// etc.
	// Para revisar posibles errores despues del DataBinding debemos agregar el
	// paametro BindingResult
	 ...
	 * System.out.println("Detale: "+detalles);
	 * 
	 * 
	 * return "vacantes/listVacantes"; }
	 */
